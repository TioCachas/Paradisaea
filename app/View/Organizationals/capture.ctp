...
$this->Html->script('controllers/Organizationals/capture', array('block' => 'scriptBottom'));
$this->Html->css('controllers/Organizationals/capture', array('block' => 'stylesTop'));
...
<div class="table-responsive" id="records">
    <table class="table table-bordered table-condensed table-striped">
        ...
        <tbody>
            <?php foreach ($organizationals as $ol): ?>
                <tr data-id="<?php echo $ol['olId']; ?>">
                    <td><?php echo $ol['olValue'] . ' ' . $units; ?></td>
                    <td><?php echo $ol['olComment']; ?></td>
                    <td>

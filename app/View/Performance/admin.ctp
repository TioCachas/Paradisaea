...
if (isset($appBosch) === true) {
    $this->Html->script('controllers/Performance/admin', array('block' => 'scriptBottom'));
    ...
    <div class="alert alert-info">
        <?php echo __("No existen estaciones de trabajo y/o códigos de falla para pérdidas de desempeño"); ?>
    </div>
    <?php
}

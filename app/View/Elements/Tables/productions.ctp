...
<div class="text-center hidden loader">
    ...
    <p><?php echo __("Buscando produccion(es)..."); ?></p>
</div>
<div class="panel panel-primary hidden detail">
    <div class="panel-heading">
        <?php echo __('Pieza(s) OK'); ?>
        <i class="fa fa-download fa-inverse fa-2x pull-right cursorPointer" title="<?php echo __('Descargar piezas ok activas'); ?>"></i>
    </div>

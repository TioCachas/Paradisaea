...
?>
<table class="table table-bordered table-condensed table-hover" id="tableOperations">
    <thead>
...
<div class="modal fade" id="modalHours" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true">
            ...
            <div class="modal-body">
                <form role="form">
                    <div class="form-group">
                        ...
                        <select class="form-control input-lg" id="hour" name="hour">
                            <?php echo $this->Bosch->hours($hours); ?>
                        </select>
                    </div>
                    <div class="form-group">
                        <label for="commentHour">
                            <?php echo __('Comentario'); ?>
                        </label>
                        <textarea class="comment form-control" rows="3" id="commentHour"></textarea>

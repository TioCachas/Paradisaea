...
class PerformanceController extends AppController {
    ...
    public function capture($operationId) {
        ...
        if (isset($operation['Operation']) === true) {
            $performance = $this->Performance->getByOperationId($operationId, array(Performance::STATUS_ENABLED));
    ...
    public function create() {
        ...
        if (isset($params['o']) && isset($params['v']) && isset($params['c'])) {
            ...
            $comment = $params['c'];
            $newRecord = $this->Performance->insert($operationId, $value, $comment);
        }
    ...
    public function delete() {
        ...
        if (isset($params['i'])) {
            $pId = $params['i'];
            $this->Performance->toggleStatus($pId);
            $success = true;
        }

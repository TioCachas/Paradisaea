...
App::uses('Organizational', 'Model');

class OrganizationalsController extends CrudController {

    /// --------------I N I C I O   C R U D-------------------------------------
    public $_model = 'Organizational';
    ...
    public function admin($operationId) {
        ...
        if (isset($operation['Operation']) === true) {
            ...
            $workstationsByLine = $this->Workstation->getEnabledByLineAndType($lineId, Workstation::TYPE_ORGANIZATIONAL);
